...
//share
jQuery(document).on("click", ".button--share",
function(e) {
	e.preventDefault();
	var $this = $(this),
	top = $this.offset().top + 20,
	left = $this.offset().left - 54;
	if ($this.hasClass('is-active')) {
		$('.popover').remove();
		$this.removeClass('is-active');
	} else {
		$this.addClass('is-active');
		oconnorBody.append('<div class="popover fade popover--bottom" style="left:' + left + 'px;top:' + top + 'px"><div class="popover-inner popover-inner--menu"><ul class="list list--borderless list--short sharePopover--simple"><li class="list-item"><button class="button--chromeless button-share" data-action-value="twitter" data-action="share-on-twitter">Share on Twitter</button></li><li class="list-item"><button class="button--chromeless button-share" data-action-value="weibo" data-action="share-on-facebook">Share on Weibo</button></li><li class="list-item"><button class="button--chromeless button-share" data-action-value="qq" data-action="share-on-facebook">Share on Qzone</button></li></ul></div><div class="popover-arrow"></div></div>');
	}
});
jQuery(document).on("click", ".button-share",
function(b) {
	b.preventDefault();
	var data = $(".button--share"),
	$this = $(this),
	...
	switch (d) {
	case "weibo":
		h = "http://service.weibo.com/share/share.php?title=" + e + "&appkey=2313279544&url=" + f + "&pic=" + g;
		break;
	case "renren":
		h = "http://widget.renren.com/dialog/share?title=" + e + "&resourceUrl=" + f + "&pic=" + g;
		break;
	case "tx":
		h = "http://share.v.t.qq.com/index.php?c=share&a=index&title=" + e + "&url=" + f + "&pic=" + g;
		break;
	case "twitter":
		h = "http://twitter.com/share?text=" + e + "&url=" + f + "&pic=" + g;
		break;
	case "qq":
		h = "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?title=" + e + "&url=" + f + "&pics=" + g;
		break;
	case "douban":
		h = "http://shuo.douban.com/%21service/share?name=" + e + "&href=" + f + "&image=" + g
	}
	return window.open(h, "Share", box),
	!1
})
//点击喜欢
