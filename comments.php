...
这篇文章<?php comments_number('还没有评论','有1条评论','有%条评论'); ?>
  ...
  <?php endif; ?>
	...
	<div id="respond">
		<h2>
		<span class="postsumbit">发表评论</span><small><?php cancel_comment_reply_link('点击取消回复'); ?></small>
		</h2>	
...
<div class="comminfo">
	...
	<?php endif; ?>
<textarea name="comment" id="comment" tabindex="4" cols="50" rows="8" placeholder="世事如书我偏爱你这一句。" onkeydown="if(event.ctrlKey&&event.keyCode==13)
{document.getElementById('submit').click();return false};"></textarea>
<input class="submit" name="submit" type="submit" id="submit" tabindex="5" value="提交（Ctrl+Enter）" /><?php comment_id_fields(); ?>
</div>
